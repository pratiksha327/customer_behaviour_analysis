...
--Q4. Compare the average Purchase Amounts between Standard and Express Shipping.
      SELECT shipping_type, ROUND(avg(purchase_amount),2) as average_shipping_amount
	  FROM customer
	  WHERE shipping_type IN ('Express','Standard')
	  GROUP BY shipping_type;

--Q5. Do subscribed customer's spend more? Compare average spend and total revenue between subscribers and non-subscribers. 
